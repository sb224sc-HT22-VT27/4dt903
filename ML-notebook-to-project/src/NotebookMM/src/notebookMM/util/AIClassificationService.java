 ...
 * Classifies code commands into three categories:
...
public class AIClassificationService {
	...
	private ClassificationResult fallbackClassification(String code) {
		...
		boolean isTraining = lowerCode.contains("model.fit") || 
		                    lowerCode.contains("model.train") || 
		...
		boolean isPreprocessing = lowerCode.contains("preprocess") || 
		                         ...
		                         lowerCode.contains("transform") ||
		                         lowerCode.contains("scaler") || 
		                         lowerCode.contains("encoder") || 
		                         lowerCode.contains("fillna") ||
		                         lowerCode.contains("dropna") || 
		                         lowerCode.contains("feature_engineer");
		
		boolean isPrediction = lowerCode.contains("predict") || 
		                      lowerCode.contains("inference") || 
		                      lowerCode.contains("model.eval") ||
		                      lowerCode.contains("predict_proba");
