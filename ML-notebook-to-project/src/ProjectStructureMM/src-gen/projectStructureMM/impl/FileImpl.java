 ...
 * </p>
 * <ul>
 *   <li>{@link projectStructureMM.impl.FileImpl#getContent <em>Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FileImpl extends FileSystemElementImpl implements File {
	...
	protected EClass eStaticClass() {
		return ProjectStructureMMPackage.Literals.FILE;
	}
	...
	public EList<String> getContent() {
		if (content == null) {
			content = new EDataTypeUniqueEList<String>(String.class, this, ProjectStructureMMPackage.FILE__CONTENT);
		}
		return content;
	}
