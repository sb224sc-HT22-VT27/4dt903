 ...
 * </p>
 * <ul>
 *   <li>{@link og.impl.MedalableImpl#getName <em>Name</em>}</li>
 *   <li>{@link og.impl.MedalableImpl#getWinnerOf <em>Winner Of</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class MedalableImpl extends MinimalEObjectImpl.Container implements Medalable {
	...
	protected EClass eStaticClass() {
		return OgPackage.Literals.MEDALABLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OgPackage.MEDALABLE__NAME, oldName, name));
	}
	...
	public EList<Event> getWinnerOf() {
		if (winnerOf == null) {
			winnerOf = new EObjectResolvingEList<Event>(Event.class, this, OgPackage.MEDALABLE__WINNER_OF);
		}
		return winnerOf;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case OgPackage.MEDALABLE__NAME:
			return getName();
		case OgPackage.MEDALABLE__WINNER_OF:
			return getWinnerOf();
		}
