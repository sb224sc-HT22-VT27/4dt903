...
/**
 * This is the item provider adapter for a {@link olympics.IndividualEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IndividualEventItemProvider extends EventItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IndividualEvent_goldMedal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IndividualEvent_goldMedal_feature", "_UI_IndividualEvent_type"),
				 OlympicsPackage.Literals.INDIVIDUAL_EVENT__GOLD_MEDAL,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addBronzeMedalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IndividualEvent_BronzeMedal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IndividualEvent_BronzeMedal_feature", "_UI_IndividualEvent_type"),
				 OlympicsPackage.Literals.INDIVIDUAL_EVENT__BRONZE_MEDAL,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSilverMedalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IndividualEvent_silverMedal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IndividualEvent_silverMedal_feature", "_UI_IndividualEvent_type"),
				 OlympicsPackage.Literals.INDIVIDUAL_EVENT__SILVER_MEDAL,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addParticipantsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IndividualEvent_participants_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IndividualEvent_participants_feature", "_UI_IndividualEvent_type"),
				 OlympicsPackage.Literals.INDIVIDUAL_EVENT__PARTICIPANTS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_IndividualEvent_type") :
