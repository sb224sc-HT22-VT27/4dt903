 ...
 * </p>
 * <ul>
 *   <li>{@link olympics.impl.TeamEventImpl#getGoldMedal <em>Gold Medal</em>}</li>
 *   <li>{@link olympics.impl.TeamEventImpl#getBronzeMedal <em>Bronze Medal</em>}</li>
 *   <li>{@link olympics.impl.TeamEventImpl#getSilverMedal <em>Silver Medal</em>}</li>
 *   <li>{@link olympics.impl.TeamEventImpl#getParticipants <em>Participants</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TeamEventImpl extends EventImpl implements TeamEvent {
	...
	protected EClass eStaticClass() {
		return OlympicsPackage.Literals.TEAM_EVENT;
	}
		...
		if (goldMedal != null && goldMedal.eIsProxy()) {
			...
			if (goldMedal != oldGoldMedal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OlympicsPackage.TEAM_EVENT__GOLD_MEDAL, oldGoldMedal, goldMedal));
			}
		}
		return goldMedal;
	}
	...
	public void setGoldMedal(Team newGoldMedal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OlympicsPackage.TEAM_EVENT__GOLD_MEDAL, oldGoldMedal, goldMedal));
	}
	...
	public Team getBronzeMedal() {
		if (bronzeMedal != null && bronzeMedal.eIsProxy()) {
			...
			if (bronzeMedal != oldBronzeMedal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OlympicsPackage.TEAM_EVENT__BRONZE_MEDAL, oldBronzeMedal, bronzeMedal));
			}
		}
		return bronzeMedal;
	}
	...
	public void setBronzeMedal(Team newBronzeMedal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OlympicsPackage.TEAM_EVENT__BRONZE_MEDAL, oldBronzeMedal, bronzeMedal));
	}
	...
	public Team getSilverMedal() {
		if (silverMedal != null && silverMedal.eIsProxy()) {
			...
			if (silverMedal != oldSilverMedal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OlympicsPackage.TEAM_EVENT__SILVER_MEDAL, oldSilverMedal, silverMedal));
			}
		}
		return silverMedal;
	}
	...
	public void setSilverMedal(Team newSilverMedal) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OlympicsPackage.TEAM_EVENT__SILVER_MEDAL, oldSilverMedal, silverMedal));
	}
	...
	public EList<Team> getParticipants() {
		if (participants == null) {
			participants = new EObjectResolvingEList<Team>(Team.class, this, OlympicsPackage.TEAM_EVENT__PARTICIPANTS);
		}
		return participants;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OlympicsPackage.TEAM_EVENT__GOLD_MEDAL:
				if (resolve) return getGoldMedal();
				return basicGetGoldMedal();
			case OlympicsPackage.TEAM_EVENT__BRONZE_MEDAL:
				if (resolve) return getBronzeMedal();
				return basicGetBronzeMedal();
			case OlympicsPackage.TEAM_EVENT__SILVER_MEDAL:
				if (resolve) return getSilverMedal();
				return basicGetSilverMedal();
			case OlympicsPackage.TEAM_EVENT__PARTICIPANTS:
