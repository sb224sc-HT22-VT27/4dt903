...
This MDE approach ensures consistency, maintainability, and traceability while significantly reducing the manual effort required to create comprehensive test suites from requirements~\cite{allala2023transforming, dias2015model}.
